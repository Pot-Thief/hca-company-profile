...
| `pnpm test`            | `vitest run`                                                                  | Unit tests: schemas, the content loader, `channelHref`, every section component, and the source-scanning conventions described in `docs/ARCHITECTURE.md`. CI runs `test:coverage` rather than this, so the thresholds apply                                                                   |
